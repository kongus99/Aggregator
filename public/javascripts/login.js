...
var _user$project$Login$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'FetchUser':
				var y = A2(_elm_lang$core$Debug$log, 'gu', model.u2);
				var x = A2(_elm_lang$core$Debug$log, 'su', model.u1);
...
var _user$project$Login$User = F2(
	function (a, b) {
		return {username1: a, username2: b};
	});
