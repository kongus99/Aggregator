	...
	var matchesSteamUsername = function (u) {
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (n) {
					return (!_elm_lang$core$String$isEmpty(n)) && A2(_elm_lang$core$String$contains, steamUsername, n);
				},
				u.steamUsername));
	};
	...
	var matchesGogUsername = function (u) {
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (n) {
					return (!_elm_lang$core$String$isEmpty(n)) && A2(_elm_lang$core$String$contains, gogUsername, n);
				},
				u.gogUsername));
	};
...
var _user$project$LoginData$LoginData = F4(
	function (a, b, c, d) {
		return {userLoaded: a, user: b, possibleUsers: c, activeUsername: d};
	});
...
var _user$project$Login$alternateSteamInput = function (data) {
	var buttonText = data.user.steamAlternate ? 'Steam login method : Alternate' : 'Steam login method : Normal';
	var buttonCheck = data.userLoaded ? _rundis$elm_bootstrap$Bootstrap_Button$attrs(
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onCheck(_user$project$Login$SteamAlternateChange),
			_1: {ctor: '[]'}
		}) : _rundis$elm_bootstrap$Bootstrap_Button$disabled(true);
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$offsetXs5,
					_1: {
						ctor: '::',
...
var _user$project$Login$sendUsersRequest = F2(
...
var _user$project$Login$CreateUpdateUser = function (a) {
	return {ctor: 'CreateUpdateUser', _0: a};
};
var _user$project$Login$actionButton = function (model) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		A2(
			_rundis$elm_bootstrap$Bootstrap_Form$row,
							...
							_rundis$elm_bootstrap$Bootstrap_Button$button,
							{
								...
								_1: {
									...
									_0: _rundis$elm_bootstrap$Bootstrap_Button$onClick(
										_user$project$Login$CreateUpdateUser(model.data.user)),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Login$SetAutoState = function (a) {
				...
				_0: A2(
					...
					},
					{
						...
						_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$disabled(model.data.userLoaded),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder(name),
									_1: {
										ctor: '::',
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(inputMsg),
										_1: {
											ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(typed),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Login$usernameForm = function (model) {
	...
	var _p4 = userData(
		_elm_lang$core$Maybe$Just(model.data.user));
	var typedSteamUsername = _p4._0;
	var typedGogUsername = _p4._1;
	var typedSteamAlternate = _p4._2;
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Form$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Login$NoOp),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$offsetXs3,
							_1: {
								ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$Login$steamInput, model, typedSteamUsername),
				_1: {
					ctor: '::',
					_0: _user$project$Login$alternateSteamInput(model.data),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Login$gogInput, model, typedGogUsername),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Login$SelectUser = function (a) {
	...
	return _thebritican$elm_autocomplete$Autocomplete$updateConfig(
		{
			...
			onKeyDown: F2(
				function (code, maybeId) {
					return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Maybe$Just(_user$project$Login$NoOp) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(_elm_lang$core$Maybe$map, _user$project$Login$SelectUser, maybeId) : _elm_lang$core$Maybe$Just(_user$project$Login$Reset));
				}),
			...
			onMouseClick: function (id) {
				return _elm_lang$core$Maybe$Just(
					_user$project$Login$SelectUser(id));
			},
				...
				case 'SelectUser':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								message: '',
								data: A2(_user$project$LoginData$selectUser, _p7._0, model.data)
							}),
						{ctor: '[]'});
				...
				case 'UserFetched':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								message: '',
								data: A2(_user$project$LoginData$setUser, _p7._0, model.data)
							}),
						{ctor: '[]'});
				case 'UsersFetched':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								message: '',
								data: A2(_user$project$LoginData$setPossibleUsers, _p7._0, model.data)
							}),
						{ctor: '[]'});
				case 'SteamChange':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								message: '',
								data: A2(_user$project$LoginData$updateSteamUsername, _p7._0, model.data)
							}),
						{ctor: '[]'});
				case 'GogChange':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								message: '',
								data: A2(_user$project$LoginData$updateGogUsername, _p7._0, model.data)
							}),
						{ctor: '[]'});
				case 'SteamGainFocus':
					return A2(
							...
							}),
						{
							...
							_0: A2(
								...
								model.data.user,
								A2(_elm_lang$core$Maybe$withDefault, '', model.data.user.steamUsername)),
							_1: {ctor: '[]'}
						});
				case 'GogGainFocus':
					return A2(
							...
							}),
						{
							...
							_0: A2(
								_user$project$Login$sendUsersRequest,
								model.data.user,
								A2(_elm_lang$core$Maybe$withDefault, '', model.data.user.gogUsername)),
							_1: {ctor: '[]'}
						});
					...
					var changeAlternate = function (args) {
						return A2(
							...
							function (_p10) {
								var _p11 = _p10;
								var _p12 = _p11._0;
								return _elm_lang$core$Native_Utils.eq(_p12, 'steamAlternate') ? {
									ctor: '_Tuple2',
									_0: _p12,
					...
					return A2(
						...
						newModel,
						{
							...
							_0: A2(
								_elm_lang$core$Maybe$withDefault,
								_elm_lang$core$Platform_Cmd$none,
								A2(_elm_lang$core$Maybe$map, sendUpdate, newModel.data.user.id)),
							_1: {ctor: '[]'}
						});
				case 'ResponseError':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								message: _elm_lang$core$Basics$toString(_p7._0)
							}),
						{ctor: '[]'});
				case 'NoOp':
					return A2(
