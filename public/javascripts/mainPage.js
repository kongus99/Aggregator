...
var _user$project$MainPage$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'DialogMessage':
				var _p2 = A3(_user$project$GameOptionsDialog$update, model.userId, _p1._0, model.options);
				var options = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
...
if (typeof _user$project$MainPage$main !== 'undefined') {
    _user$project$MainPage$main(Elm['MainPage'], 'MainPage', {"types":{"message":"MainPage.Msg","aliases":{"Model.GogEntry":{"type":"{ title : String , link : String , gogId : Int , price : Maybe.Maybe Float , discounted : Maybe.Maybe Float }","args":[]},"Model.GameOptions":{"type":"{ entry : Model.SteamEntry, queries : Array.Array Model.GameQuery }","args":[]},"Model.GameQuery":{"type":"{ query : String , site : String , results : List String , selectedResult : Maybe.Maybe String }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]},"Model.PriceEntry":{"type":"{ steamId : Int , name : String , host : String , link : String , price : Float }","args":[]},"Model.SteamEntry":{"type":"{ name : String , steamId : Int , link : String , price : Maybe.Maybe Float , discounted : Maybe.Maybe Float }","args":[]},"GameEntry.GameEntry":{"type":"{ gog : List Model.GogEntry , steam : List Model.SteamEntry , prices : List Model.PriceEntry }","args":[]}},"unions":{"Filters.Msg":{"tags":{"ChangeLow":["String"],"ChangeHigh":["String"],"ReceiveError":["Http.Error"],"ReceiveEntries":["List GameEntry.GameEntry"],"ChangeGameOn":["String"],"ChangeDiscounted":["Bool"],"ChangeSources":["String"],"ChangeName":["String"],"Clear":[]},"args":[]},"MainPage.Msg":{"tags":{"DialogData":["Model.GameOptions"],"DialogClose":[],"ServerRefreshRequest":["String"],"DialogOpen":["Maybe.Maybe Int"],"FiltersMessage":["Filters.Msg"],"DialogMessage":["GameOptionsDialog.Msg"],"GeneralError":["Http.Error"],"Ack":["String"]},"args":[]},"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Array.Array":{"tags":{"Array":[]},"args":["a"]},"Maybe.Maybe":{"tags":{"Nothing":[],"Just":["a"]},"args":["a"]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]},"GameOptionsDialog.Msg":{"tags":{"DialogError":["Http.Error"],"Switched":["String"],"ChangeQuery":["Int","String"],"GetNewResults":["Int"],"NewResults":["Model.GameOptions"],"SwitchTo":["Int","String"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
