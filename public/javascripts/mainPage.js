...
var _user$project$Price$updateLowRange = F2(
	function (low, range) {
		return _elm_lang$core$Native_Utils.update(
			range,
			{low: low});
	});
var _user$project$Price$isDiscounted = function (price) {
	return !_elm_lang$core$Native_Utils.eq(price.discounted, _elm_lang$core$Maybe$Nothing);
};
var _user$project$Price$discountedIfAvailable = function (price) {
	var selectPrice = function (_p0) {
		var _p1 = _p0;
		var _p2 = _p1.discounted;
		return _elm_lang$core$Native_Utils.eq(_p2, _elm_lang$core$Maybe$Nothing) ? _elm_lang$core$Maybe$Just(_p1.normal) : _p2;
	};
...
var _user$project$Price$priceToString = function (price) {
	var formatDiscounted = function (discounted) {
		var percentage = _elm_lang$core$Basics$round(((price.normal - discounted) / price.normal) * 100);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_user$project$Price$roundToString, 2, price.normal),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' (-',
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'%) ',
						A2(_user$project$Price$roundToString, 2, discounted)))));
	};
	return A2(
		_elm_lang$core$Maybe$withDefault,
		A2(_user$project$Price$roundToString, 2, price.normal),
		A2(_elm_lang$core$Maybe$map, formatDiscounted, price.discounted));
};
var _user$project$Price$Price = F2(
	function (a, b) {
		return {normal: a, discounted: b};
	});
var _user$project$Price$PriceRange = F2(
	function (a, b) {
		return {low: a, high: b};
	});
var _user$project$Price$AlternatePrice = F5(
	function (a, b, c, d, e) {
...
var _user$project$Model$GogEntry = F5(
	function (a, b, c, d, e) {
		return {title: a, link: b, gogId: c, price: d, genres: e};
	});
var _user$project$Model$SteamEntry = F6(
	function (a, b, c, d, e, f) {
		return {name: a, steamId: b, link: c, price: d, genres: e, tags: f};
	});
var _user$project$Model$NamedEntry = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Model$ComparisonEntry = F4(
	function (a, b, c, d) {
...
var _user$project$GameEntry$GameEntryRow = F8(
	function (a, b, c, d, e, f, g, h) {
		return {steamId: a, gameOn: b, name: c, link: d, genres: e, tags: f, price: g, alternatePrices: h};
	});
	...
	var steamToRow = function (s) {
		return A8(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (pr) {
					return {value: pr, serialize: _user$project$Price$priceToString};
				},
				s.price),
			gameEntry.prices);
	};
						...
						function (_p3) {
							...
							switch (_p5.ctor) {
								...
								case 'WishList':
									return _p7;
								default:
									return A2(_elm_lang$core$List$append, _p7, _p6);
							}
						},
						newData.games))));
	});
...
var _user$project$Router$decodedComparisonEntry = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Model$ComparisonEntry,
	A2(_elm_lang$core$Json_Decode$field, 'left', _user$project$Router$decodedNamedEntry),
...
var _user$project$Router$decodedAlternatePrice = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Price$AlternatePrice,
...
var _user$project$Router$decodedPrice = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Price$Price,
	A2(_elm_lang$core$Json_Decode$field, 'normal', _elm_lang$core$Json_Decode$float),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'discounted', _elm_lang$core$Json_Decode$float)));
...
var _user$project$Router$decodedGogEntry = A6(
	...
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'price', _user$project$Router$decodedPrice)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'genres',
		A2(_user$project$Router$csvRowDecoder, ',', _elm_lang$core$Json_Decode$string)));
var _user$project$Router$decodedSteamEntry = A7(
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Filters$sendRefresh(model),
					_1: {ctor: '[]'}
				}
			})
	};
											...
											_1: {
												...
												_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(
													A2(
														_elm_lang$core$Maybe$withDefault,
														'',
														A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, model.range.low))),
												_1: {ctor: '[]'}
											}
										}
									}),
													...
													_1: {
														...
														_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(
															A2(
																_elm_lang$core$Maybe$withDefault,
																'',
																A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, model.range.high))),
														_1: {ctor: '[]'}
													}
												}
											}),
			...
			},
			{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(currentResult),
										_1: {
											ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(currentResult),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$GameOptionsDialog$dialogHeader = F2(
...
var _user$project$GameOptionsDialog$refresh = F2(
	function (msg, model) {
		return A2(
			_elm_lang$http$Http$send,
			A2(_user$project$Router$resolveResponse, msg, model.error),
			function (_) {
				return _.request;
			}(
				_user$project$Router$routes.gameOptions.triggerRefresh(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'steamId',
								_1: _elm_lang$core$Basics$toString(model.steamId)
							},
							_1: {ctor: '[]'}
						}
					})));
	});
var _user$project$GameOptionsDialog$close = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{state: _rundis$elm_bootstrap$Bootstrap_Modal$hiddenState});
};
...
var _user$project$GameOptionsDialog$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {userId: a, steamId: b, message: c, gameOptions: d, state: e, success: f, error: g};
	});
var _user$project$GameOptionsDialog$model = F5(
	function (userId, steamId, success, error, options) {
		return A7(
			...
			_rundis$elm_bootstrap$Bootstrap_Modal$visibleState,
			success,
			error);
	});
var _user$project$GameOptionsDialog$emptyModel = F4(
	function (userId, steamId, success, error) {
		return A7(_user$project$GameOptionsDialog$Model, userId, steamId, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _rundis$elm_bootstrap$Bootstrap_Modal$hiddenState, success, error);
	});
...
var _user$project$GameOptionsDialog$open = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		A2(
			_user$project$Router$resolveResponse,
			function (r) {
				return model.success(
					_user$project$GameOptionsDialog$NewResults(r));
			},
			model.error),
		function (_) {
			return _.request;
...
var _user$project$GameOptionsDialog$newResults = F2(
	function (serialized, model) {
		return A2(
			_elm_lang$http$Http$send,
...
var _user$project$GameOptionsDialog$saveSwitched = F2(
	function (serialized, model) {
		return A2(
			_elm_lang$http$Http$send,
		...
		switch (_p1.ctor) {
			case 'SwitchTo':
				...
				return {
					...
					_1: A2(_user$project$GameOptionsDialog$saveSwitched, serialized, newModel)
				};
			case 'Switched':
				return {
					ctor: '_Tuple2',
			...
			case 'GetNewResults':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						newModel,
						{message: _elm_lang$core$Maybe$Nothing}),
					_1: A2(_user$project$GameOptionsDialog$newResults, serialized, model)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							state: _rundis$elm_bootstrap$Bootstrap_Modal$visibleState
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$GameOptionsDialog$tableRow = F3(
	function (wrapper, index, gameQuery) {
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Table$tr,
			{ctor: '[]'},
			{
								...
								A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$HtmlHelpers$onEnter(
...
var _user$project$GameOptionsDialog$dialogBody = F3(
	function (wrapper, options, config) {
		return A3(
			_rundis$elm_bootstrap$Bootstrap_Modal$body,
			{ctor: '[]'},
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Table$table(
					{
						...
						thead: _user$project$GameOptionsDialog$tableHead,
						tbody: A2(
							...
							_elm_lang$core$Array$toList(
								A2(
									...
									_user$project$GameOptionsDialog$tableRow(wrapper),
									options.queries)))
					}),
				_1: {ctor: '[]'}
			},
				...
				function (o) {
					return A2(
						...
						A3(
							...
							A3(
								_user$project$GameOptionsDialog$dialogBody,
								model.success,
								o,
								A2(
									_user$project$GameOptionsDialog$dialogHeader,
									o,
									_rundis$elm_bootstrap$Bootstrap_Modal$large(
										_rundis$elm_bootstrap$Bootstrap_Modal$config(close))))));
				},
				model.gameOptions));
	});

var _user$project$MainPage$toStyle = function (gameEntry) {
	return _elm_lang$core$Native_Utils.eq(gameEntry.gameOn, _elm_lang$core$Maybe$Nothing) ? 'cell_Both' : (_elm_lang$core$Native_Utils.eq(
		gameEntry.gameOn,
		_elm_lang$core$Maybe$Just(_user$project$Model$Gog)) ? 'cell_Gog' : 'cell_Steam');
};
var _user$project$MainPage$alternatePrices = function (priceEntries) {
	var price = function (e) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_user$project$Price$roundToString, 2, e.price)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$MainPage$gameTableTitle = _rundis$elm_bootstrap$Bootstrap_Table$simpleThead(
	{
		ctor: '::',
		_0: A2(
			_rundis$elm_bootstrap$Bootstrap_Table$th,
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'ServerRefreshRequest':
				var newValues = _user$project$Router$decodeWebSocketResult(_p1._0);
				var newFilters = A2(_user$project$Filters$replace, newValues, model.filters);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DialogOpen':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$GameOptionsDialog$open(options),
						_1: {ctor: '[]'}
					});
			case 'DialogClose':
				var options = _user$project$GameOptionsDialog$close(model.options);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					{
						ctor: '::',
						_0: A2(_user$project$GameOptionsDialog$refresh, _user$project$MainPage$Ack, options),
						_1: {ctor: '[]'}
					});
			case 'GeneralError':
				return {
			...
			case 'DialogMessage':
				var _p2 = A2(_user$project$GameOptionsDialog$update, _p1._0, model.options);
				var options = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
			...
			case 'FiltersMessage':
				...
				var _p3 = A2(_user$project$Filters$update, _p1._0, model.filters);
				var newFilters = _p3._0;
				var cmd = _p3._1;
...
var _user$project$MainPage$DialogClose = function (a) {
	return {ctor: 'DialogClose', _0: a};
};
					...
					_1: {
						...
						_1: {
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fa fa-cog align-top float-right'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
			...
			_1: {
				...
				_0: A2(
					_rundis$elm_bootstrap$Bootstrap_Table$td,
					{
						ctor: '::',
						_0: _rundis$elm_bootstrap$Bootstrap_Table$cellAttr(
							_elm_lang$html$Html_Attributes$class('text-left')),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$GameEntry$serializeValue(e.genres)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$GameEntry$serializeValue(e.tags)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Table$td,
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Table$cellAttr(
									_elm_lang$html$Html_Attributes$class('text-right')),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Maybe$withDefault,
										'',
										A2(_elm_lang$core$Maybe$map, _user$project$GameEntry$serializeValue, e.price))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_rundis$elm_bootstrap$Bootstrap_Table$td,
								{ctor: '[]'},
								_user$project$MainPage$alternatePrices(e.alternatePrices)),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_0: A2(
					...
					_user$project$MainPage$FiltersMessage,
					_user$project$Filters$subscriptions(model.filters)),
				_1: {ctor: '[]'}
			}
		});
};
...
if (typeof _user$project$MainPage$main !== 'undefined') {
    _user$project$MainPage$main(Elm['MainPage'], 'MainPage', undefined);
}
