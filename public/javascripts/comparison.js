...
if (typeof _user$project$Comparison$main !== 'undefined') {
    _user$project$Comparison$main(Elm['Comparison'], 'Comparison', {"types":{"message":"Comparison.Msg","aliases":{"Comparison.ComparisonParameters":{"type":"{ leftOn : Model.GameOn , rightOn : Model.GameOn , minimumMetric : Int }","args":[]},"Model.NamedEntry":{"type":"{ id : Int, name : String }","args":[]},"Model.ComparisonEntry":{"type":"{ left : Model.NamedEntry , metricResult : Int , right : Model.NamedEntry , matches : Bool }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Comparison.Msg":{"tags":{"ToggleStored":["String"],"Toggle":["Int","Int"],"RefreshData":["Comparison.ComparisonParameters"],"DataError":["Http.Error"],"ReceiveData":["List Model.ComparisonEntry"]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]},"Model.GameOn":{"tags":{"Steam":[],"Gog":[]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
